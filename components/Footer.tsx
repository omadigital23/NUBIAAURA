      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href={`/${locale}/catalogue`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
                  {t('nav.catalog', 'Catalogue')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/sur-mesure`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
                  {t('nav.custom', 'Sur-Mesure')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/a-propos`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
                  {t('nav.about', 'À propos')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/contact`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href={`/${locale}/mentions-legales`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
                  {t('footer.legal_mentions', 'Mentions légales')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/politique-de-confidentialite`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
                  {t('footer.privacy', 'Politique de confidentialité')}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/conditions-generales`} className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center space-x-2 text-nubia-black/70">
                <Mail size={16} />
                <a href="mailto:contact@nubiaaura.com" className="hover:text-nubia-gold transition-colors">
                  {t('footer.email', 'contact@nubiaaura.com')}
                </a>
              </li>
              <li className="flex items-center space-x-2 text-nubia-black/70">
                <Phone size={16} />
                <a href="tel:+221771234567" className="hover:text-nubia-gold transition-colors">
                  {t('footer.phone', '+221 77 123 45 67')}
                </a>
              </li>
              <li className="flex items-start space-x-2 text-nubia-black/70">
        ...
        <div className="border-t border-nubia-gold/20 pt-8 mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-nubia-black/70 mb-4">{t('footer.secure_payments', 'Paiements sécurisés via Flutterwave')}</p>
            <div className="flex flex-wrap justify-center gap-6">
              {paymentMethods.map((method) => (
                <div key={method.name} className="flex flex-col items-center group cursor-pointer">
                  ...
                  <span className="text-xs text-nubia-black/70 mt-2 group-hover:text-nubia-gold transition-colors font-medium">{method.name}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="border-t border-nubia-gold/20 pt-8 mb-8">
          <div className="flex justify-center space-x-6">
            <a href="#" className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
              <Facebook size={20} />
            </a>
            <a href="#" className="text-nubia-black/70 hover:text-nubia-gold transition-colors">
              <Instagram size={20} />
        ...
        <div className="border-t border-nubia-gold/20 pt-8 text-center text-sm text-nubia-black/70">
          <p>{t('footer.copyright', `© ${currentYear} Nubia Aura. Tous droits réservés. Développé par OMA Digital`)}</p>
        </div>
      </div>
    </footer>
  );
