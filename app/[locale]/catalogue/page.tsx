                ...
                {list.map((product) => (
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      return imageUrl ? (
                        <div className="relative w-full h-72 sm:h-80 md:h-96 lg:h-[480px] bg-gradient-to-br from-nubia-gold/10 to-nubia-gold/5 overflow-hidden flex-shrink-0 flex items-center justify-center">
                          <img
